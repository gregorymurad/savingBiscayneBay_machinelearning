...
final_content.to_csv(r'All_Data/biscayne_all_data.csv', index = False, header=True)
...
df_filtered.to_csv(r'All_Data/biscayne_all_data_filtered.csv', index = False, header=True)